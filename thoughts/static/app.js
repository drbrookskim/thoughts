...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================================
    // 🌌 BACKGROUND PARTICLE NETWORK CONSTELLATION
    // ==========================================================================
    ...
    if (canvas) {
        ...
        function renderParticles() {
            ...
            const particleColor = isDark ? 'rgba(255, 255, 255, 0.4)' : 'rgba(41, 37, 36, 0.3)';
            const lineColor = isDark ? 'rgba(255, 255, 255, 0.08)' : 'rgba(41, 37, 36, 0.06)';
